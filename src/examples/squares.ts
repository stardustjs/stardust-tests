...
export class SquaresVisualization {

    private makeSquaresMark(side: string, mode: string) {
    ...
    private _canvas: d3.Selection<any, any, any, any>;
    private _platform: StardustWebGL.WebGLCanvasPlatform2D;
    private _canvasNode: HTMLCanvasElement;
    private _svg: d3.Selection<any, any, any, any>;
    private _svgAxis: d3.Selection<any, any, any, any>;
    ...
    constructor(container: HTMLDivElement) {
        ...
        let platform = new StardustWebGL.WebGLCanvasPlatform2D(this._canvasNode);
    ...
    layout() {
        ...
        var d3yscale = d3.scaleLinear().domain(this._marks.yScale.domain()).range(this._marks.yScale.range());
        var axis = d3.axisLeft(d3yscale);
...
import { TestCase, registerTestCase, loadCSV } from "../common";

export class SquaresTestCase extends TestCase {
    ...
    public async initialize(element: HTMLDivElement, width: number, height: number) {
        ...
        divElement.setAttribute("class", "squares-container");
        element.appendChild(divElement);
        var vis = new SquaresVisualization(divElement);
        let data = await loadCSV("data/mnist.csv");
        vis.layout();
